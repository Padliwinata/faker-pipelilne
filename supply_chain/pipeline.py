...
@asset
def final_reporting(context: AssetExecutionContext, customer_segmentation: list[dict], payment_reconciliation_report: list[dict], inventory_report: dict) -> MaterializeResult:
